    ...
    if(data.seller){
      return (
        ...
        <div class="ml-5">
          ...
          <div class={toggle}>
            <div class="py-3">
              <Link to={"/dashboard"}><span class="block text-center text-sm text-blue-600 dark:text-white p-1">{data.firstname + " " + data.lastname}</span></Link>
        ...
        <div class="ml-5">
          ...
          <div class={toggle}>
            ...
            <ul class="py-2" aria-labelledby="user-menu-button">
              ...
              <li>
                <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Addresses</a>
              </li>
              <li>
                <Link to={"/login"} class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Sign out</Link>
              </li>
