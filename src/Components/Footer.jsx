...
function Footer(props) {
  return (
    ...
    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://flowbite.com/" className="hover:underline">{props.heading}</a>. All Rights Reserved.
    </span>
